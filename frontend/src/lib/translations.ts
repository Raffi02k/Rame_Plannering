...
const UI_TRANSLATIONS = {
  sv: {
    ...
    userGreeting: 'Hej',
    userNow: 'Just nu',
    userNoTasks: 'Inga uppgifter just nu',
    userStaffToday: 'Personal idag',
    userLater: 'Senare',
    contacts: 'Kontakt',
    manager: 'Chef',
    nurse: 'Sjuksköterska',
  ...
  en: {
    ...
    userGreeting: 'Hello',
    userNow: 'Just now',
    userNoTasks: 'No tasks right now',
    userStaffToday: 'Staff today',
    userLater: 'Later',
    contacts: 'Contacts',
    manager: 'Manager',
    nurse: 'Nurse',
  ...
  ar: {
    ...
    staffView: 'عرض الموظفين',
    userView: 'عرض المستفيد',
    userGreeting: 'مرحبا',
    userNow: 'الآن',
    userNoTasks: 'لا توجد مهام الآن',
    userStaffToday: 'الموظفون اليوم',
    userLater: 'لاحقا',
    contacts: 'اتصال',
    manager: 'مدير',
    nurse: 'ممرض',
  ...
  es: {
    ...
    userGreeting: 'Hola',
    userNow: 'Ahora',
    userNoTasks: 'No hay tareas ahora',
    userStaffToday: 'Personal hoy',
    userLater: 'Más tarde',
    contacts: 'Contacto',
    manager: 'Jefe',
    nurse: 'Enfermera',
